...
Authentication Setup
The AuthenticationOptions in the Ocelot configuration specifies the authentication provider key (TestKey) that should be configured in the API Gateway project.
Ensure that the authentication middleware is set up in Startup.cs of the API Gateway project.
```
```Running the Project
1.Clone the repository:


git clone https://github.com/your-repository/MicroServicesOcelotAuth.git
